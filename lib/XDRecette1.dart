  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          Pinned.fromPins(
            Pin(size: 166.0, start: 30.0),
            Pin(size: 22.0, start: 169.0),
            child: Text(
              'Bo bun (Vietnam)',
              style: TextStyle(
          ...
          Pinned.fromPins(
            Pin(start: 69.0, end: 30.0),
            Pin(size: 99.0, middle: 0.553),
            child: Text(
