    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 35.0, middle: 0.3699),
            Pin(size: 14.0, start: 202.5),
            child: Text(
              '91 avis',
              style: TextStyle(
          ...
          Pinned.fromPins(
            Pin(size: 88.5, start: 30.0),
            Pin(size: 15.0, start: 202.0),
            child: Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(size: 16.5, middle: 0.0),
          ...
          Pinned.fromPins(
            Pin(size: 60.7, middle: 0.4459),
            Pin(size: 18.0, middle: 0.3714),
            child:
          ...
          Pinned.fromPins(
            Pin(size: 94.0, end: 30.0),
            Pin(size: 14.0, middle: 0.3703),
            child:
          ...
          Pinned.fromPins(
            ...
            Pin(size: 158.0, middle: 0.2625),
            child:
                // Adobe XD layer: 'PhotoBobun' (shape)
                Container(
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: const AssetImage('assets/images/BoBun.jpg'),
                  fit: BoxFit.cover,
                ),
              ),
            ),
          ...
          Pinned.fromPins(
            ...
            Pin(size: 32.0, middle: 0.4061),
            child:
                // Adobe XD layer: 'ComposantIngredients' (component)
                XDComposantIngredients(),
          ),
          Pinned.fromPins(
            Pin(size: 77.0, middle: 0.7919),
            Pin(size: 18.0, middle: 0.4032),
            child:
          ...
          Pinned.fromPins(
            ...
            Pin(size: 50.0, middle: 0.4943),
            child:
                // Adobe XD layer: 'Nems' (group)
                Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(start: -8.0, end: -32.0),
                  ...
                  child:
                    ...
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image: const AssetImage('assets/images/Nems.jpg'),
                        fit: BoxFit.cover,
                      ),
                    ),
                  ),
              ...
              children: <Widget>[
                Pinned.fromPins(
                  ...
                  child:
                    ...
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image: const AssetImage('assets/images/Carottes.jpg'),
                        fit: BoxFit.cover,
                      ),
                    ),
                  ),
              ...
              children: <Widget>[
                Pinned.fromPins(
                  ...
                  child:
                    ...
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image: const AssetImage('assets/images/Cacahuetes.jpg'),
                        fit: BoxFit.cover,
                      ),
                    ),
                  ),
              ...
              children: <Widget>[
                Pinned.fromPins(
                  ...
                  child:
                    ...
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image: const AssetImage('assets/images/Steak.jpg'),
                        fit: BoxFit.cover,
                      ),
                    ),
                  ),
          ...
          Pinned.fromPins(
            ...
            Pin(size: 50.0, middle: 0.5953),
            child:
                // Adobe XD layer: 'GoussesAil' (group)
                Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(start: -20.0, end: -20.0),
                  ...
                  child:
                    ...
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image: const AssetImage('assets/images/Ail.jpg'),
                        fit: BoxFit.cover,
                      ),
                    ),
                  ),
                ...
                Pinned.fromPins(
                  ...
                  child:
                    ...
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image:
                            const AssetImage('assets/images/Sauce_Huitre.jpg'),
                        fit: BoxFit.cover,
                      ),
                    ),
                  ),
              ...
              children: <Widget>[
                Pinned.fromPins(
                  ...
                  child:
                    ...
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image: const AssetImage('assets/images/Soja.jpg'),
                        fit: BoxFit.cover,
                      ),
                    ),
                  ),
              ...
              children: <Widget>[
                Pinned.fromPins(
                  ...
                  child:
                    ...
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image: const AssetImage('assets/images/Batavia.jpg'),
                        fit: BoxFit.cover,
                      ),
                    ),
                  ),
              ...
              children: <Widget>[
                Pinned.fromPins(
                  ...
                  child:
                    ...
                    decoration: BoxDecoration(
                      image: DecorationImage(
                        image: const AssetImage('assets/images/Nuoc_Nam.jpg'),
                        fit: BoxFit.cover,
                      ),
                    ),
                  ),
          ...
          Pinned.fromPins(
            Pin(size: 106.0, middle: 0.3271),
            Pin(size: 19.0, middle: 0.4948),
            child: Text(
              '8 nems',
              style: TextStyle(
                fontFamily: 'Proxima Nova',
          ...
          Pinned.fromPins(
            Pin(size: 93.0, middle: 0.3121),
            Pin(size: 32.0, middle: 0.5514),
            child: Text(
          ...
          Pinned.fromPins(
            Pin(size: 170.0, middle: 0.5024),
            Pin(size: 29.0, middle: 0.4436),
            child:
                // Adobe XD layer: 'Personnes' (group)
                Stack(
              children: <Widget>[
                Pinned.fromPins(
                  ...
                  child: Container(
                    decoration: BoxDecoration(
                      ...
                      color: const Color(0xffffffff),
                      border: Border.all(
                          width: 1.0, color: const Color(0xffdbe2ea)),
                    ),
                  ),
                ),
                Pinned.fromPins(
                ...
                Pinned.fromPins(
                  Pin(size: 18.2, start: 13.6),
                  Pin(size: 18.2, middle: 0.5598),
                  child:
...
const String _svg_nhf5ev =
    '<svg viewBox="0.0 0.0 18.2 18.2" ><path  d="M 0 0 L 18.17693328857422 0 L 18.17693328857422 18.17693328857422 L 0 18.17693328857422 L 0 0 Z" fill="none" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_xe72vb =
    '<svg viewBox="3.8 8.3 10.6 1.5" ><path transform="translate(-1.21, -2.67)" d="M 15.60321140289307 12.51474475860596 L 5 12.51474475860596 L 5 11 L 15.60321140289307 11 L 15.60321140289307 12.51474475860596 Z" fill="#009fe3" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_eterkn =
    '<svg viewBox="0.0 0.0 24.0 24.0" ><path  d="M 0 0 L 24 0 L 24 24 L 0 24 L 0 0 Z" fill="none" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_dsyimm =
    '<svg viewBox="2.0 2.0 20.0 19.0" ><path  d="M 22 9.239999771118164 L 14.80999946594238 8.619999885559082 L 12 2 L 9.189999580383301 8.630000114440918 L 2 9.239999771118164 L 7.460000038146973 13.96999931335449 L 5.820000171661377 21 L 12 17.27000045776367 L 18.18000030517578 21 L 16.55000114440918 13.96999931335449 L 22 9.239999771118164 Z M 12 15.39999961853027 L 8.239999771118164 17.67000007629395 L 9.239999771118164 13.38999938964844 L 5.920000076293945 10.50999927520752 L 10.30000019073486 10.1299991607666 L 12 6.099999904632568 L 13.71000003814697 10.13999938964844 L 18.09000015258789 10.51999950408936 L 14.77000045776367 13.39999961853027 L 15.77000045776367 17.68000030517578 L 12 15.39999961853027 Z" fill="#ffffff" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
const String _svg_sdn49n =
    '<svg viewBox="137.5 945.0 100.0 1.0" ><path transform="translate(-1238.5, 556.87)" d="M 1376 388.130859375 L 1476 388.130859375" fill="none" stroke="#f2f3f6" stroke-width="4" stroke-miterlimit="4" stroke-linecap="round" /></svg>';
